  ...
  <div class="bo-layout">
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <router-link class="nav-item" to="/backoffice/settings">
        ...
        <router-link class="nav-item" to="/backoffice/couts-categorie">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zM12 18h-1V6h3c1.1 0 2 .9 2 2v2c0 1.1-.9 2-2 2h-2v6z"/></svg>
          Coût par Catégorie
        </router-link>
